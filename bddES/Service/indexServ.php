...
include_once('../Controller/indexServAjoutController.php');
include_once('../Controller/indexServModifController.php');
include_once('../Controller/indexServDelController.php');
?>
                ...
                <div class="col-sm-10 mb-5">
                    <table class="table table-striped table-dark">
                        ...
                        <tbody class="text-center">
                                <?php
                                    $service = new ServiceMysqliDAO;
                                    $dataR = $service->research();
                                    foreach ($dataR as $value) 
                                    {
                                        ...
                                        <tr> 
                                                ...
                                                <td> {$value['service']}</td>
                                                <td> {$value['ville']}</td>
                                                <td><a class="btn btn-primary" href="formAjoutServ.php?action=modif&noserv={$value["noserv"]}"> Modifier</a></td>
                                                <td><a class="btn btn-success" href="formDetailServ.php?action=voir&noserv={$value["noserv"]}"> Consulter</a></td>
                                            
BOUTTON;                                                                               
                                        $dataSOS = ServiceMysqliDAO::supoupas();
                                        $tail=count($dataSOS);
