...
<body><h3 class="text-center">Formulaire de modification</h3>
    <form class="tableau text-center m-5" action="indexServ.php?action=modif&amp;noserv=<?php echo $noserv?>" method="post"> 
            <input class="col-4 text-center" type="text" name="modifnoserv" value="<?php echo $noserv?>"> </br>
            <input class="col-4 text-center" type="text" name="modifservice" value="<?php echo $serv?>" ><br/>
