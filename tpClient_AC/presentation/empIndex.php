...
function empIndex($admin, $tabResearch, $tabSupOne, $compter, $errorCode=null, $filtre){
    ...
    elseif($errorCode && $errorCode == 24000){
        echo "<center><div class='alert alert-success'> L'employé a bien été ajouté ! !</div></center>";
    }
    elseif($errorCode && $errorCode == 24001){
        echo "<center><div class='alert alert-success'> L'employé a bien été modifié ! !</div></center>";
    }
...
function empFormAjout($errorCode=null){
    if ($errorCode && $errorCode == 1062) {
        echo "<center><div class='alert alert-danger'> Cet employé existe déjà ! !</div></center>";
    }
...
?>
<form id="formulaire" class="text-center m-5" action="../controller/controllerEmpIndex.php?action=ajouterOK" method="post">
       <h3>Formulaire d'inscription</h3>
            ...
            <input class="col-6 text-center col-1 btn btn-primary m-2"  id="ajoutEmp" type="submit" onclick="compte()" name="ajouter" value="Envoyez"> 
    </form>
...
<script src="../presentation/jquery-3.5.1.min.js"></script>
<script src="../presentation/js.js"></script>
</html>
<?php    
}

function empFormModif($objectResearch, $errorCode=null){
...
function empDetail($admin, $objectResearch, $errorCode=null){
