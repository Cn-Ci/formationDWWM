<?php
function empIndex($admin, $tabResearch, $tabSupOne, $errorCode=null){
    var_dump($errorCode, $e, $se);
    if($errorCode && $errorCode == 23001){
        echo "<center><div class='alert alert-danger'> Erreur lors de l'affichage de la page Employé! !</div></center>";
    }
    elseif($errorCode && $errorCode == 1062){
        echo "<center><div class='alert alert-danger'> code : Cet Employé existe déjà ! !</div></center>";
    }
